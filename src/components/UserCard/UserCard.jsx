...
class Modal extends React.Component {
    constructor(props) {
        ...
        this.resetAttempt=this.resetAttempt.bind(this);
    }
    showReset(){
        this.setState({
    ...
    render(){
        let modalClass = this.props.show ? "modal" : "modal display-none";
        // console.log("length",Object.keys(this.props.user).length);
            ...
            return (
                ...
                <div className="modal-main">
                    <div className="modal-content">
                        ...
                        <img src={userPic} alt="Profile" className="profile-icon"/>
                        <h2>{this.props.user['name']}</h2>
                        <p>{this.props.user['regno']}</p>
                        ...
                        <div className="icon-container">
                            ...
                            <p>+91 {this.props.user['phone']}</p>
                        </div>
                        {this.props.user['isSelectedTechnical'] || this.props.user['isSelectedDesign'] || this.props.user['isSelectedManagement']?
                            <div className="icon-container second">
                                <img src={profile} alt="phone" className="icons"/>
                                {this.props.user['isSelectedTechnical'] ? <p>Technical</p> : null}
                                {this.props.user['isSelectedDesign'] ? <p>|&nbsp; Design</p> : null}
                                {this.props.user['isSelectedManagement'] ?<p>|&nbsp; Management</p> : null}
                            </div>
                        : <div className="icon-container second"></div>    
                        }
                        <button className="reattempt" onClick={this.showReset}>{this.state.showReset ? <p>Hide Me</p>: <p>Allow Re-attempt</p>}</button>
                        {this.state.showReset ? 
                            <div className="reattempt-container">
                                <input type="radio" value="technical" className="input" id="technical"></input>
                                <label htmlFor="technical" onClick={()=>this.resetAttempt("technical",this.props.user['regno'])}><p>Technical</p></label>
                                <input type="radio" value="design" className="input" id="design"></input>
                                <label htmlFor="design" onClick={()=>this.resetAttempt("design",this.props.user['regno'])}><p>Design</p></label>
                                <input type="radio" value="management" className="input" id="management"></input>
                                <label htmlFor="management" onClick={()=>this.resetAttempt("management",this.props.user['regno'])}><p>Management</p></label>
                            </div> : null }
                        <hr></hr>
                        <div className="score-container">
                            <div className="score-sub">
                                ...
                                <p className="score">{this.props.user['techscore']} Points</p>
                            </div>
                            <div className="score-sub">
                                <svg width="20" height="20" viewBox="0 0 55 43" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p className="score">{this.props.user['designscore']} Points</p>
                            </div>
                            <div className="score-sub">
                                <svg width="20" height="20" viewBox="0 0 45 56" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <p className="score">{this.props.user['managementscore']} Points</p>
                            </div>
                        </div>
                    </div>
                    </div>
                ...
                <div className={modalClass}>
                    <div className="modal-main">
                        <div className="modal-content">
                            <div className="close" onClick={this.props.onHide}></div>
                            <br />
                            <p>Have you entered a Registration number? </p>
                            <p>If yes, wait or go back and enter one!</p>
